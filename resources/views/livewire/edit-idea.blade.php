        ...
        <div
            ...
            <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                ...
                <form wire:submit.prevent="updateIdea" action="" method="post" class="space-y-4 px-4 py-6">
                    <div>
                        <input wire:model.defer="title" x-ref="title" type="text" class="w-full bg-slate-100 border-none text-sm rounded-xl placeholder-slate-900 px-4 py-2" placeholder="Your Idea" required>
                        @error('title')
