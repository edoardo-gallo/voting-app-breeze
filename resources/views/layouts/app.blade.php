...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans bg-gray-background text-gray-900 text-sm">
        <header class="flex items-center justify-between px-8 py-4">
            ...
            <a href="#" class="ml-4">
                <img src="{{ asset('img/logo_blu_finale.svg')}}" alt="logo" width="200px" height="20px">
            </a>
        ...
        <main class="container mx-auto max-w-custom flex">
            <div class="w-70 mr-5">
                ...
                >
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        <p class="text-xs mt-4">Let us know what you like</p>
                    </div>

                    <form action="" method="post" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text" class="w-full bg-slate-100 border-none text-sm rounded-xl placeholder-slate-900 px-4 py-2" placeholder="Your Idea">
                        </div>
                        <div>
                            <select name="category_add" id="category_add" class="w-full text-sm bg-slate-100 rounded-xl border-none px-4 py-2">
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4" class="w-full bg-slate-100 rounded-xl placeholder-slate-900 text-sm px-4 py-2 border-none" placeholder="Describie your Idea"></textarea>
                        </div>
            ...
            <div class="w-175">
                <nav class="flex items-center justify-between text-xs">
                    <ul class="flex uppercase font-semibold border-b-4 border-slate-300 pb-3 space-x-10">
                        <li><a href="#" class="border-b-4 pb-3 border-blue">All ideas</a></li>
                        <li><a href="#" class="text-slate-300 border-slate-300 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue hover:text-slate-800">All ideas</a></li>
                        <li><a href="#" class="text-slate-300 border-slate-300 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue hover:text-slate-800">All ideas</a></li>
                    </ul>
                    <ul class="flex uppercase font-semibold border-b-4 border-slate-300 pb-3 space-x-10">
                        <li><a href="#" class="text-slate-300 border-slate-300 transition duration-150 ease-in border-b-4 pb-3 hover:border-blue hover:text-slate-800">All ideas</a></li>
